...
| **任务管理铁律** ⭐ 2026-06-05 新增 | `references/task-management-and-cost.md` | task ID 必存 + wait 打断校验 + ark list 救援 + 任务成本意识（**批量提交必读**）|
...
### ⚠️ status 状态读取陷阱（2026-06-10 Rabbit Clip4 实测 · 必看）⭐⭐⭐
...
### 任务管理 5 必避 + 4 必查（速查版 · 2026-06-07 加第 5 条）
...
- ❌ **客户端报错就当服务端没跑成**（**先 list 端点核对**——2026-06-07 pic2 实战：客户端报"API 401"但服务端 8 个全 succeeded，本地文件名错位才是真问题）
